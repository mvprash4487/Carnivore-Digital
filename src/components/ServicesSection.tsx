  ...
  return (
    <section id="services" className="py-32 md:py-44 relative" ref={ref}>
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        >
          <p className="text-xs tracking-[0.4em] uppercase text-primary font-sans mb-4">02 — Select Your Floor</p>
          <h2 className="font-serif text-3xl md:text-5xl font-bold">
            Every Floor, A <span className="text-gold-gradient italic">Specialty</span>
          </h2>
          <p className="text-muted-foreground font-sans text-sm mt-4 max-w-md mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {services.map((service, i) => (
            ...
            >
              {/* Floor button badge */}
              <div className="absolute top-6 right-6 w-9 h-9 rounded-full border border-primary/40 flex items-center justify-center group-hover:border-primary group-hover:bg-primary/10 transition-all duration-300">
                <span className="text-[10px] tracking-wider text-primary font-sans font-semibold">{service.floor}</span>
              </div>
